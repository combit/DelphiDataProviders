...
{$WEAKPACKAGEUNIT ON}
uses
  Classes, SysUtils, Windows, ListLabel27;

type

  TPrintPreviewThread = class(TThread)
  private
    FPrintInstance      : TListLabel27;
    FProjectFile        : string;
  ...
  public
    ...
    property PrintInstance: TListLabel27 read FPrintInstance write FPrintInstance;
...
implementation
uses cmbtLS27x, LLDataSetDataProvider;
