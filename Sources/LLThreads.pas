...
{$WEAKPACKAGEUNIT ON}
uses
  Classes, SysUtils, Windows, ListLabel28;

type

  TPrintPreviewThread = class(TThread)
  private
    FPrintInstance      : TListLabel28;
    FProjectFile        : string;
  ...
  public
    ...
    property PrintInstance: TListLabel28 read FPrintInstance write FPrintInstance;
...
implementation
uses cmbtLS28x, LLDataSetDataProvider;
